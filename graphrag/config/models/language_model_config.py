...
class LanguageModelConfig(BaseModel):
    ...
    def _validate_api_key(self) -> None:
        ...
        if (
            ...
            raise ApiKeyMissingError(self.type, self.auth_type.value)
    ...
    def _validate_auth_type(self) -> None:
        ...
        if (
            self.auth_type == AuthType.NoneAuth
            and (
            ...
            msg = "auth_type of none is not supported for Azure-hosted models. Please set auth_type to api_key or azure_managed_identity."
            raise ConflictingSettingsError(msg)
