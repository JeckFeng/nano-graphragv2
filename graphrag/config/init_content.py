...
models:
  {defs.DEFAULT_CHAT_MODEL_ID}:
    # Default chat model: DeepSeek (online)
  ...
  {defs.DEFAULT_EMBEDDING_MODEL_ID}:
    # Default embedding model: local Ollama
    ...
    tokens_per_minute: null
    requests_per_minute: null
# Example: DeepSeek (replace or add new model ids as needed)
#  deepseek_chat:
#    type: chat
#    model_provider: deepseek
#    auth_type: api_key
...
# Optional override of DeepSeek base endpoint
