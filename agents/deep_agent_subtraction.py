...
def create_math_agent() -> tuple:
    ...
    agent = create_deep_agent(
        ...
        interrupt_on={
            "subtract_numbers": True,  # 调用减法工具时中断，等待人工审核
        },
        checkpointer=checkpointer,
        system_prompt="""你是一个数学助手。使用 subtract_numbers 工具来计算两数之差。

**严格规则**：
1. 禁止自己进行任何计算，无论多简单，必须使用 subtract_numbers 工具
